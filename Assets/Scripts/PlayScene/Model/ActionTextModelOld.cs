 ...
 * 记录游戏中玩家操作，用于ui展示
 */
public class ActionTextModelOld
{
    ...
    public ActionTextModelOld(string selfName_, string enemyName_)
    {
        totalText = "";
        toastText = null;
        selfName = selfName_;
    ...
    public void ChooseCard(bool isSelf, CardModelOld card, CardSelectType selectType)
    {
        string name = GetName(isSelf);
    ...
    public void ApplyScorch(List<CardModelOld> cardList)
    {
        if (cardList.Count == 0) {
            return;
        }
