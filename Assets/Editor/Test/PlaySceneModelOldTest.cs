...
public class PlaySceneModelOldTest
{
    private static string TAG = "PlaySceneModelOldTest";

    private PlaySceneModelOld hostModel; // 以下测试都以host为self的视角

    private PlaySceneModelOld playerModel;
    ...
    public void SetUp()
    {
        ...
        // 测试用，先把CardGeneratorOld的资源加载了
        CardGeneratorOld cardGenerator = new CardGeneratorOld();
        cardGenerator.GetCard(2001);
        // 初始化
        hostModel = new PlaySceneModelOld();
        playerModel = new PlaySceneModelOld(false);
    ...
    private void CheckCurState(PlaySceneModelOld model, PlayStateTracker.State expectedState)
    {
    ...
    public IEnumerator Normal()
    {
        ...
        Thread hostThread = new Thread(() => {
            ...
            CardModelOld selectedCard = selfHandRowAreaModel.cardList[0];
    ...
    public IEnumerator Spy()
    {
        ...
        Thread hostThread = new Thread(() => {
            ...
            Assert.AreEqual(true, hostModel.IsTurn(true));
            Assert.AreEqual(false, hostModel.IsTurn(false));
            List<CardModelOld> tempList = new List<CardModelOld>(hostModel.selfSinglePlayerAreaModel.backupCardList);
            CardModelOld selectedCard = selfHandRowAreaModel.cardList[0];
            hostModel.ChooseCard(selectedCard);
            CardModelOld newCard = tempList.Find(card => !hostModel.selfSinglePlayerAreaModel.backupCardList.Contains(card));
        ...
        Thread playerThread = new Thread(() => {
            ...
            Assert.AreEqual(true, playerModel.IsTurn(true)); // playerModel视角
            Assert.AreEqual(false, playerModel.IsTurn(false));
            List<CardModelOld> tempList = new List<CardModelOld>(playerModel.selfSinglePlayerAreaModel.backupCardList);
            CardModelOld selectedCard = selfHandRowAreaModel.cardList[0];
            playerModel.ChooseCard(selectedCard);
            CardModelOld newCard = tempList.Find(card => !playerModel.selfSinglePlayerAreaModel.backupCardList.Contains(card));
            Assert.AreEqual(9 + 2, selfHandRowAreaModel.cardList.Count);
    ...
    public IEnumerator ScorchWood()
    {
        ...
        Thread hostThread = new Thread(() => {
            ...
            hostModel.DrawInitHandCard();
            hostModel.ReDrawInitHandCard();
            CardModelOld normalCard;
            CardModelOld scorchCard;
    ...
    public IEnumerator MedicMedic()
    {
        ...
        Thread hostThread = new Thread(() => {
            ...
            CardModelOld medicCard = TestGenCards.GetCard(2027, 21);
            CardModelOld normalCard = TestGenCards.GetCard(2043, 31);
    ...
    public IEnumerator MedicLeader()
    {
        ...
        Thread hostThread = new Thread(() => {
            ...
            hostModel.selfSinglePlayerAreaModel.discardAreaModel.AddCard(TestGenCards.GetCard(2043, 31));
            // host出牌，打出复活牌
            CardModelOld leaderCard = hostModel.selfSinglePlayerAreaModel.leaderCardAreaModel.cardList[0];
    ...
    public IEnumerator DecoyNoTarget()
    {
        ...
        Thread hostThread = new Thread(() => {
            ...
            hostModel.DrawInitHandCard();
            hostModel.ReDrawInitHandCard();
            CardModelOld roleCard;
            CardModelOld decoyCard;
    ...
    public IEnumerator Leader()
    {
        ...
        Thread hostThread = new Thread(() => {
            ...
            hostModel.DrawInitHandCard();
            hostModel.ReDrawInitHandCard();
            CardModelOld roleCard = selfHandRowAreaModel.cardList[0];
            CardModelOld leaderCard = hostModel.selfSinglePlayerAreaModel.leaderCardAreaModel.cardList[0];
            CheckCurState(hostModel, PlayStateTracker.State.WAIT_SELF_ACTION);
    ...
    public IEnumerator Monaka()
    {
        ...
        Thread hostThread = new Thread(() => {
            ...
            CardModelOld firstCard = selfHandRowAreaModel.cardList[0];
